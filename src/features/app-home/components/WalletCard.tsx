...
export function WalletCard({
  ...
  return (
    <section
      ...
      className="mx-4 rounded-2xl overflow-hidden  bg-background border p-1"
    >
      {/* Card Header */}
      <div className="px-5 pt-5 pb-4">
        <div className="flex items-start justify-between mb-5">
          <div className="flex flex-col gap-0.5">
            <span className="text-[11px] text-muted leading-none">موجودی کیف پول</span>
            <div className="flex items-baseline gap-2 mt-1 h-7">
              {hidden ? (
        ...
        <div className="flex gap-2.5">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 h-10 rounded-xl bg-ute active:scale-[0.97] text-foreground text-[13px] font-semibold transition-all"
          >
            ...
            className="flex-1 flex items-center justify-center gap-1.5 h-10 rounded-xl bg-black hover:bg-gray-950 active:scale-[0.97] text-white text-[13px] font-semibold transition-all"
          >
      ...
      <div
        className="flex justify-between items-center px-10 py-1 divide-white/[0.07] border-t border-white/[0.07]"
        role="list"
      ...
      >
        ...
        >
          <span className="text-[10px] text-muted">دات گلد</span>
        ...
        <div
          ...
          className="flex flex-col items-center justify-center gap-0.5"
        >
          <span className="text-[10px] text-muted">امتیاز دات</span>
