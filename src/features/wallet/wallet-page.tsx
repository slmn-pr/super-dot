...
export function WalletPage() {
    ...
    const primaryBalance = { code: "STAR" as CurrencyCode, label: "STAR", amount: starBalance };
    const secondaryBalance = { code: "DOTO" as CurrencyCode, label: "DOTO", amount: dotoBalance };
    ...
    return (
        <div className="mx-auto flex w-full max-w-md flex-col gap-6 px-4 py-6 sm:max-w-lg sm:py-8 lg:max-w-xl">
            ...
            <div className="flex flex-col gap-4 animate-in fade-in duration-300">
                <CurrencyTabs value={activeCurrency} onValueChange={setActiveCurrency} />
